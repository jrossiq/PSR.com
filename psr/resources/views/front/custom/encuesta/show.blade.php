...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type="text/css"  href="/css/front/encuesta.min.css?v={{str_random(40)}}" >
  ...
  <body class="site">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                @include('front.custom.encuesta.form');
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript" src="/js/front/encuesta.js?v={{str_random(40)}}"></script>
